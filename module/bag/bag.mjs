export function fillBag(){
    ...
    let d = new Dialog({
        ...
        buttons: {
            ...
            label: "Confirm",
            callback: () => { 
            let white_tokens = parseInt(document.getElementById('white_tokens').value)
            let black_tokens = parseInt(document.getElementById('black_tokens').value)
            let baggie = []
            if(white_tokens>0){
...
export function addRandom(){
    ...
    let d = new Dialog({
        ...
        buttons: {
            ...
            label: "Confirm",
            callback: () => { 
            let tokens = parseInt(document.getElementById('tokens').value)
            var white_tokens = 0;
            var black_tokens = 0;
...
export async function emptyBag(){
    ...
    let white_tokens = 0
    let black_tokens = 0
    await journal.setFlag("nte", 'white', null)
    await journal.setFlag("nte", 'black', null)
    ...
    let d = new Dialog({
        ...
        buttons: {
            ...
            callback: () => {
                ...
                let white_tokens = game.journal.getName('_bag_').getFlag('nte', 'white');
                let black_tokens = game.journal.getName('_bag_').getFlag('nte', 'black');
                let check = white_tokens + black_tokens
                ...
                if (check > 0){
                    ...
                    setTokensFlagForUser(white_tokens, 'white')
                    setTokensFlagForUser(black_tokens, 'black')
                    if(!blind){

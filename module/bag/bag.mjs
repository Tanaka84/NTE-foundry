...
export  function drawToken(){
    let d = new Dialog({
        title: "Add a blind token",
        content: "<h3>Draw</h3><br><label for='tokens'><b>How many tokens are you drawing?</b> </label><input type='number' id='tokens' placeholder='0' style='width: 10%;'><br><br><label for='checkbox'><b>Is this a blind draw?: </b> </label><input type='checkbox' id='checkbox'><br><br>",
        buttons: {
            Draw: {
